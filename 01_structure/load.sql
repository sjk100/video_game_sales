\copy raw_staging_games FROM 'path/to/coding_projects/video_game_sales/vgsales.csv' DELIMITER ',' CSV HEADER NULL 'N/A';
\copy staging_games FROM 'path/to/coding_projects/video_game_sales/vgsales.csv' DELIMITER ',' CSV HEADER NULL 'N/A';
